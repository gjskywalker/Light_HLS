...
; <label>:88                                      ; preds = %96, %filtez.exit.i23.i
  ...
  br i1 %89, label %90, label %quantl.exit.i.i
...
; <label>:90                                      ; preds = %88
  ...
  %94 = ashr i32 %93, 15
  %95 = icmp sgt i32 %., %94
  br i1 %95, label %96, label %quantl.exit.i.i

; <label>:96                                      ; preds = %90
  %97 = add nsw i32 %mil.i.i.i.0, 1
  br label %88

quantl.exit.i.i:                                  ; preds = %90, %88
...
; <label>:109                                     ; preds = %quantl.exit.i.i
  %110 = icmp sgt i32 %107, 18432
  %.488 = select i1 %110, i32 18432, i32 %107
  br label %logscl.exit.i24.i

logscl.exit.i24.i:                                ; preds = %109, %quantl.exit.i.i
  %.0470 = phi i32 [ 0, %quantl.exit.i.i ], [ %.488, %109 ]
  %111 = lshr i32 %.0470, 6
  %112 = and i32 %111, 31
