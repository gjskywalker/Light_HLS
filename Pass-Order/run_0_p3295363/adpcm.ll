...
; <label>:76                                      ; preds = %84, %filtez.exit.i23.i
  ...
  br i1 %78, label %79, label %quantl.exit.i.i
...
; <label>:79                                      ; preds = %76
  ...
  %82 = ashr i32 %81, 15
  %83 = icmp sgt i32 %., %82
  br i1 %83, label %84, label %quantl.exit.i.i

; <label>:84                                      ; preds = %79
  %85 = add nsw i32 %77, 1
  br label %76

quantl.exit.i.i:                                  ; preds = %79, %76
