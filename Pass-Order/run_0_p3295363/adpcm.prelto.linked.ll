...
; <label>:4                                       ; preds = %1
  ...
  %11 = load i32* %10, align 4
  %12 = call i32 @encode(i32 %7, i32 %11) #2
  %13 = load i32* %i, align 4
  %14 = sdiv i32 %13, 2
  %15 = getelementptr inbounds [100 x i32]* @compressed, i32 0, i32 %14
...
; <label>:23                                      ; preds = %20
  %24 = load i32* %i, align 4
  %25 = sdiv i32 %24, 2
  %26 = getelementptr inbounds [100 x i32]* @compressed, i32 0, i32 %25
  %27 = load i32* %26, align 4
  call void @decode(i32 %27) #2
  %28 = load i32* @xout1, align 4
  %29 = load i32* %i, align 4
  %30 = getelementptr inbounds [100 x i32]* @result, i32 0, i32 %29
  store i32 %28, i32* %30, align 4
  %31 = load i32* @xout2, align 4
  %32 = load i32* %i, align 4
  %33 = add nsw i32 %32, 1
  %34 = getelementptr inbounds [100 x i32]* @result, i32 0, i32 %33
...
; <label>:46                                      ; preds = %39
  %47 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0)) #2
  br label %48
