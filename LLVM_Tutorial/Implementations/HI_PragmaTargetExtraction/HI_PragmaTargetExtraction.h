...
public:
    ...
    HI_PragmaTargetExtraction( // const char* config_file_name,
        ...
        : ModulePass(ID), IRLoop2LoopLabel(IRLoop2LoopLabel), FuncParamLine2OutermostSize(FuncParamLine2OutermostSize),
    ...
    HI_PragmaTargetExtraction( // const char* config_file_name,
        ...
        std::map<std::pair<std::string, std::string>, HI_PragmaArrayInfo> &TargetExtName2ArrayInfo, bool DEBUG = 0)
        : ModulePass(ID), IRLoop2LoopLabel(IRLoop2LoopLabel), FuncParamLine2OutermostSize(FuncParamLine2OutermostSize),
          IRFunc2BeginLine(IRFunc2BeginLine), DEBUG(DEBUG),
          LoopIRName2NextLevelSubLoopIRNames(LoopIRName2NextLevelSubLoopIRNames), LoopIRName2Depth(LoopIRName2Depth),
          LoopIRName2Array(LoopIRName2Array), TargetExtName2ArrayInfo(TargetExtName2ArrayInfo)
