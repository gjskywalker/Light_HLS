...
public:
    ...
    HI_LoopUnroll(std::map<std::string, std::string> &_IRLoop2LoopLabel,
                  ...
                  Optional<unsigned> Threshold = std::nullopt, Optional<unsigned> Count = std::nullopt,
                  Optional<bool> AllowPartial = std::nullopt, Optional<bool> Runtime = std::nullopt, Optional<bool> UpperBound = std::nullopt,
    ...
    LoopUnrollResult tryToUnrollLoop(Loop *L, DominatorTree &DT, LoopInfo *LI, ScalarEvolution &SE,
